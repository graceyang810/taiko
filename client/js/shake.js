$(document).ready(function(){
	...
	function waitchoosesong(){		
		$.getJSON("../json/get_response.json",{'id':$.cookie('player_id'),'anotherid':$("#anotheravtor").attr("playerid"),'feedback':1},function(data){
	...
	$("#refuse").click(function(){	
		$.getJSON("../json/get_response.json",{'id':$.cookie('player_id'),'anotherid':$("#anotheravtor").attr("playerid"),'feedback':0},function(data){
			console.log("拒绝");
		});		
	})
	...
	function sendinvite(){
		$.getJSON("../json/get_invite.json",{'id':$.cookie('player_id'),'anotherid':$("#avatar2").attr("playerid")},function(data){
			if(data[0].feedback == true){
				if(data[1].resp == 1){
					console.log("同意");
					$("#modal5").modal({	      				
