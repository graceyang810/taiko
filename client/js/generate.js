var m_name1 = [ "慕容", "任", "于", "厉", "钟离", "唐", "东方", "敖", "公孙", "南宫", "邵",
		"司徒", "尉迟", "司空", "尹", "明", "西门", "归海", "莫", "尚", "上官" ];
// var m_name1 =
// ["赵","钱","孙","李","周","吴","郑","王","冯","陈","褚","卫","蒋","沈","韩","杨","朱","秦","尤","许","何"];
var m_name2 = [ "爵", "逸", "寒", "封", "萧", "云", "燚", "轩", "海", "元", "天", "寂" ];
// var m_name2 = ["长", "栓", "大", "来", "狗", "守", "傻", "福", "屎", "二", "胖", "臭"];
var m_name3 = [ "言", "洛", "鸿", "涯", "夜", "痕", "清", "飞", "尘", "阳", "武", "遥",
		"风", "空", "遐", "竹", "涵", "偌", "御", "伦", "滨", "浪", "璘", "勇", "恒", "基",
		"明", "岚", "舜", "翰", "遐" ];
// var m_name3 = ["娟", "妮", "腿", "娣", "球", "坑", "年", "岁", "娃", "毛", "剩", "姑",
// "英", "妹", "肥", "霞", "狗", "虎", "花", "凤", "定", "村", "蛋", "妞", "木", "翠", "爱",
// "财", "石", "美", "发"];

var f_name1 = [ "慕容", "任", "于", "厉", "钟离", "唐", "东方", "敖", "白", "南宫", "竺",
		"司徒", "尉迟", "司空", "蓝", "邵", "西门", "颜", "上官", "欧阳", "尚", "莫" ];
var f_name2 = [ "真", "碧", "凝", "竹", "若", "雨", "紫", "影", "亦", "伊", "允", "冰" ];
var f_name3 = [ "菲", "星", "芮", "悠", "馨", "香", "爱", "翎", "洛", "轩", "儿", "萱",
		"雪", "月", "嫣", "凌", "珣", "痕", "荫", "茹", "忆", "婷", "舞", "琦", "汐", "嫌",
		"钰", "心", "韵", "然", "嫣" ];
									...
									function() {
										if ($(".sex:checked").val() == "male") {
											...
											for (n = 1; n <= 5; n++) {
												$("#" + "name_slide" + n)
														.empty();
												strname = "<p style='margin-top:20px;margin-left:30%;color:white;font-size:60px;'>"
														+ generatemalename();
												+"</p>";
												$("#name_slide" + n).html(
														strname);
											...
											for (m = 1; m <= 10; m++) {
												$("#" + "avatar_slider" + m)
														.empty();
												stravatar = "<img style='margin-top:45px;margin-left:40%;color:white;font-size:60px;width:20%;' src='../images/m"
														+ m + ".png'>";
												$("#avatar_slider" + m).html(
														stravatar);
											}
										}
										if ($(".sex:checked").val() == "female") {
											...
											for (m = 1; m <= 10; m++) {
												$("#" + "avatar_slider" + m)
														.empty();
												stravatar = "<img style='margin-top:45px;margin-left:40%;color:white;font-size:60px;width:20%;' src='../images/f"
														+ m + ".png'>";
												$("#avatar_slider" + m).html(
														stravatar);
											}
